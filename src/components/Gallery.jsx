...
const Gallery = () => {
  return (
    <div className='py-[10px] ' id="gallery">
      ...
      <div className="flex justify-center mb-[20px] mt-[20px]"><a href="/drawing"><button className=" font-inter font-semibold border border-white text-white rounded-[40px] w-[212px] h-[48px]">See More </button></a></div>
      <hr />
      </div>
    </div>
  )
